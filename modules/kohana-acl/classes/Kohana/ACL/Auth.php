...
class Kohana_ACL_Auth implements ACL_Auth_Interface {
	...
	public function __construct()
	{
		...
		if (isset($this->_user->role_id) OR ( null !== Arr::get($this->_user, 'role_id'))) //UPDATE 8.07.2024
		{
			//$id = $this->_user->role_id;
			$id = Arr::get($this->_user, 'role_id'); 
		if (isset($this->_user->role_id) OR ( null !== Arr::get($this->_user, 'role_id'))) 
