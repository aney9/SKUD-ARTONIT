...
return array(
    ...
    'screenFormatRFID' => 'Формат вывода номера RFID на экран: либо в формате хранения в базе данных, либо в формате DEC',
	...
	'_formatViewAll' => 'Разрешает вывод на экран всех вариантов отображения номера RFID (0,1,2)',
	...
	'descBaseFormatRfid'=>'Формат хранение номера идентификатора в базе данных СКУД. Для новых объектов рекомендую выбирать формат HEX. <b>Смена формата данных после настройки запрещена!</b>',
    'formatViewAll'=>'Показывать номер идентификатора во всех возможных вариантах.',
    'regFormatRfid'=>'Указывает на формат ввода номера идентификатора. Регистрационных считыватель должен выдавать номер идентификатора в этом формате.',
    'screenFormatRFID_'=>'screenFormatRFID',
    'viewFromatForEdit'=>'viewFromatForEdit',
);