...
CREATE PROCEDURE VALIDATEPASS_HL_PARKING_3 (
    ID_DEV INTEGER,
    ID_CARD VARCHAR(12),
    GRZ VARCHAR(12))
RETURNS (
...
DESCRIBE PROCEDURE VALIDATEPASS_HL_PARKING_3
...
GRANT SELECT ON CARD TO PROCEDURE VALIDATEPASS_HL_PARKING_3;

GRANT SELECT ON PEOPLE TO PROCEDURE VALIDATEPASS_HL_PARKING_3;
...
GRANT SELECT ON HL_SETTING TO PROCEDURE VALIDATEPASS_HL_PARKING_3;

GRANT SELECT ON HL_GARAGENAME TO PROCEDURE VALIDATEPASS_HL_PARKING_3;

GRANT SELECT ON HL_INSIDE TO PROCEDURE VALIDATEPASS_HL_PARKING_3;

GRANT SELECT ON SS_ACCESSUSER TO PROCEDURE VALIDATEPASS_HL_PARKING_3;

GRANT SELECT ON ACCESS TO PROCEDURE VALIDATEPASS_HL_PARKING_3;

GRANT EXECUTE ON PROCEDURE VALIDATEPASS_HL_PARKING_3 TO SYSDBA;