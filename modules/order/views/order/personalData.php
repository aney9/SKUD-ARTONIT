        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (saveJPGButton) {
                saveJPGButton.addEventListener('click', () => {
                    ...
                    const fullName = '<?php echo isset($full_name) ? htmlspecialchars($full_name) : 'Unknown'; ?>';
                    ...
                    // Отправляем на сервер вместо локального скачивания
                    ...
                    .catch(error => {
                        showMessage('Ошибка при отправке на сервер.', 'error');
